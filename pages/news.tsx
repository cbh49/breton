          ...
          <thead>
            <tr>
              <th colSpan={2}>
                ...
                <h3>Stanley Cup Game 7 Best Bets</h3>
              </th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td colSpan={2}>
                <p>Our AI Model searched the web to find the best bets for Stanley Cup Game 7. <br />Published: 6/24</p>
                <button className={styles.button}><Link href="/StanleyCupGame6"><h4>Read More</h4><span className={styles.span}/></Link>
                </button>
              </td>
            </tr>
          </tbody>
