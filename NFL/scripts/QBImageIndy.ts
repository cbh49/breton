...
async function generateImageForTrend(trendType: string, title: string, filename: string) {
  ...
  const htmlContent = `
    ...
    <head>
      <meta charset="utf-8">
      <title>NFL Quarterback Props - ${title}</title>
      <style>
        @font-face {
...
async function generateAllImages() {
  const trendConfigs = [
    {
      trendType: 'completions',
      title: 'NFL QB COMPLETIONS PROPS',
      filename: 'quarterback-completions-props.png'
    },
    {
      trendType: 'pass_attempts',
      title: 'NFL QB PASS ATTEMPTS PROPS',
      filename: 'quarterback-pass-attempts-props.png'
    },
    {
      trendType: 'pass_yards',
      title: 'NFL QB PASS YARDS PROPS',
      filename: 'quarterback-pass-yards-props.png'
    },
    {
      trendType: 'pass_touchdowns',
      title: 'NFL QB PASS TDs PROPS',
      filename: 'quarterback-pass-touchdowns-props.png'
    }
  ];

  console.log('Starting generation of 4 quarterback prop images...');
  ...
  console.log('All quarterback prop images generated successfully!');
}
